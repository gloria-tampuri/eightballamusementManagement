  ...
  return (
    <div className={classes.assert}>
      ...
      <ul className={classes.summary}>
        ...
        <li>Date Installed: <span className={classes.emphasis}>{current?.startDate}</span></li>
        ...
        <li>Table Accessories: <span className={classes.emphasis}> {current?.accessories} </span></li>
